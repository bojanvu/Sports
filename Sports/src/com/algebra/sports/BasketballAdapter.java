...
public class BasketballAdapter extends ArrayAdapter<String> {

	private final Context context;
	private final String[] Ids;
	private final int rowResourceId;

	public BasketballAdapter(Context context, int textViewResourceId,
			String[] objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String imageFile = BasketballData.GetbyId(id).IconFile;

		textViewName.setText(BasketballData.GetbyId(id).Name);
		textViewAddress.setText(BasketballData.GetbyId(id).Address);
		textViewMail.setText(BasketballData.GetbyId(id).Mail);
		textViewPhone.setText(BasketballData.GetbyId(id).Phone);
