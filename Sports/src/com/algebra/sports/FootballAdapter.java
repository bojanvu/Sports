...
public class FootballAdapter extends ArrayAdapter<String> {

	private final Context context;
	private final String[] Ids;
	private final int rowResourceId;

	public FootballAdapter(Context context, int textViewResourceId,
			String[] objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String imageFile = FootballData.GetbyId(id).IconFile;

		textViewName.setText(FootballData.GetbyId(id).Name);
		textViewAddress.setText(FootballData.GetbyId(id).Address);
		textViewMail.setText(FootballData.GetbyId(id).Mail);
		textViewPhone.setText(FootballData.GetbyId(id).Phone);
