...
public class ChessAdapter extends ArrayAdapter<String> {
	...
	public ChessAdapter(Context context, int textViewResourceId,
			String[] objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String imageFile = ChessData.GetbyId(id).IconFile;

		textViewName.setText(ChessData.GetbyId(id).Name);
		textViewAddress.setText(ChessData.GetbyId(id).Address);
		textViewMail.setText(ChessData.GetbyId(id).Mail);
		textViewPhone.setText(ChessData.GetbyId(id).Phone);
