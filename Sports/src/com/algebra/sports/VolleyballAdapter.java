...
public class VolleyballAdapter extends ArrayAdapter<String> {

	private final Context context;
	private final String[] Ids;
	private final int rowResourceId;

	public VolleyballAdapter(Context context, int textViewResourceId,
			String[] objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String imageFile = VolleyballData.GetbyId(id).IconFile;

		textViewName.setText(VolleyballData.GetbyId(id).Name);
		textViewAddress.setText(VolleyballData.GetbyId(id).Address);
		textViewMail.setText(VolleyballData.GetbyId(id).Mail);
		textViewPhone.setText(VolleyballData.GetbyId(id).Phone);
